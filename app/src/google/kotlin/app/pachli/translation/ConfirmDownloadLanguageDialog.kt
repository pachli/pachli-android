 ...
 *
 * @property language ISO code of the language to download.
 * @property displayLanguage Name of the language, in the user's locale.
 */
@Immutable
@Parcelize
data class ConfirmDownloadLanguageDialogState(
    val language: String,
    val displayLanguage: String,
) : Parcelable {
    companion object {
        fun from(viewData: TranslationModelViewData) = ConfirmDownloadLanguageDialogState(
...
/**
 * Displays a dialog for the user to confirm downloading a language model
 *
 * @param state
 ...
 */
@Composable
internal fun ConfirmDownloadLanguageDialog(
    ...
    PachliAlertDialog(
        dialogTitle = stringResource(R.string.fragment_confirm_download_language_dialog_title_fmt, displayLanguage ?: ""),
        dialogText = stringResource(R.string.fragment_confirm_download_language_dialog_msg),
        modifier = Modifier.testTag("ConfirmDownloadLanguageDialog"),
        isVisible = s != null,
...
@ThemePreviews
@Composable
internal fun PreviewConfirmDownloadLanguageDialog() {
    PreviewPachliTheme {
        ConfirmDownloadLanguageDialog(
            state = {
                ConfirmDownloadLanguageDialogState(
                    language = "fr",
