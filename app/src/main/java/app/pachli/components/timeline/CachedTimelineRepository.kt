...
class CachedTimelineRepository @Inject constructor(
    ...
    override suspend fun getStatusStream(
        ...
        // the paging source to ensure the user's clicks to show/hide collections,
        // collection membership changes, etc, are reflected in the UI.
 ...
 *
 * To fix this, this paging source wraps [TimelineDao.getStatusesWithQuote]. When
...
private class ResolveCollectionCardsPagingSource(
    ...
    override fun getRefreshKey(state: PagingState<Int, TimelineStatusWithQuote>): Int? =
