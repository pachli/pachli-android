 ...
 * normally be used, use the constructor that takes an [app.pachli.core.database.model.PachliAccountEntity].
 */
...
value class AccountIdentifier internal constructor(val value: String) :
    ...
    Parcelable {
    /**
     * Creates a new [AccountIdentifier] from an [app.pachli.core.database.model.PachliAccountEntity]. The
...
//    constructor(pachliAccountEntity: PachliAccountEntity) : this("${pachliAccountEntity.domain}:${pachliAccountEntity.accountId}")
    ...
    constructor(domain: String, serverId: String) : this("$domain:$serverId")
