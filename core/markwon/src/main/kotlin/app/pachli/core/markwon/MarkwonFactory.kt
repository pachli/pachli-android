...
package app.pachli.core.markwon

import android.content.Context
import android.graphics.Color
import androidx.core.text.method.LinkMovementMethodCompat
import app.pachli.core.markwon.PreProcessMastodonHtml.processMarkdown
...
object MarkwonFactory {
    fun makeMarkwon(context: Context, textSize: Float) = Markwon.builder(context)
 ...
 */
private class PachliMarkwonTheme(private val context: Context, private val textSize: Float) : AbstractMarkwonPlugin() {
 ...
 * @see [processMarkdown]
 */
private object PreProcessMastodonHtml : AbstractMarkwonPlugin() {
