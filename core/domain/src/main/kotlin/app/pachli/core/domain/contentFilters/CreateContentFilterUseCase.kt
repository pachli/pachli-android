...
class CreateContentFilterUseCase @Inject constructor(
    ...
    suspend operator fun invoke(
        ...
        return externalScope.async {
            ...
            return@async contentFiltersRepository.createContentFilter(server, filter)
                .onSuccess { accountManager.createContentFilter(pachliAccountId, it) }
        }.await()
    }
}
