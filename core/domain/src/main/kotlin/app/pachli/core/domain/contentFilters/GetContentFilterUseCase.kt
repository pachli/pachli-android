...
class GetContentFilterUseCase @Inject constructor(
    ...
    suspend operator fun invoke(
        ...
        return externalScope.async {
            ...
            return@async contentFiltersRepository.getContentFilter(server, filterId)
                .onSuccess { accountManager.updateContentFilter(pachliAccountId, it) }
        }.await()
    }
}
